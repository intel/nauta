...
const ELASTICSEARCH_SERVICE = 'dls4enterprise-elasticsearch';
const ELASTICSEARCH_NAMESPACE = 'dls4e';
const ELASTICSEARCH_PORT = 9200;

const getElasticsearchServiceUrl = function () {
  const devUrl = `http://localhost:9090/api/v1/namespaces/${ELASTICSEARCH_NAMESPACE}/services/${ELASTICSEARCH_SERVICE}:dls4e/proxy`;
