...
import (
	...
	versioned "github.com/nervanasystems/carbon/applications/experiment-service/pkg/client/clientset/versioned"
	internalinterfaces "github.com/nervanasystems/carbon/applications/experiment-service/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/nervanasystems/carbon/applications/experiment-service/pkg/client/listers/aggregator/v1"
...
func (f *runInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aggregatorv1.Run{}, f.defaultInformer)
}
