...
import (
	...
	"github.com/nervanasystems/carbon/applications/experiment-service/pkg/client/informers_generated/externalversions"
...
func (si *SharedInformers) startInformers(shutdown <-chan struct{}) {
	go si.Factory.Aggregator().V1().Runs().Informer().Run(shutdown)
}
