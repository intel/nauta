...
import (
	...
	. "github.com/nervanasystems/carbon/applications/test-exp-service/pkg/client/clientset_generated/clientset/typed/aggregator/v1"
)
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.AggregatorV1().Runs("run-test-valid")
