...
mkdir -vp /go/src/github.com/docker/docker
cd /go/src/github.com/docker/docker 
tar --strip-components=1 -xf /root/rpmbuild/SOURCES/engine.tgz
...
/go/src/github.com/docker/docker/bundles/dynbinary-daemon/dockerd -v
...
# is:
install -p -m 755 /go/src/github.com/docker/docker/bundles/dynbinary-daemon/dockerd $RPM_BUILD_ROOT/%{_bindir}/dockerd
...
install -p -m 644 /go/src/github.com/docker/docker/contrib/init/systemd/docker.service $RPM_BUILD_ROOT/%{_unitdir}/docker.service
install -p -m 644 /go/src/github.com/docker/docker/contrib/init/systemd/docker.socket $RPM_BUILD_ROOT/%{_unitdir}/docker.socket
